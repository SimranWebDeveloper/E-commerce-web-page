      ...
      <nav className="container-fluid px-3 ">
        <div className="row d-flex align-items-center">
          ...
          <div className="col-lg-4 col-md-4 col-sm-2 col-1 ">
            <ul className="d-none d-xl-flex pt-3  justify-start align-items-center list-unstyled  fw-semibold">
              <li className="pe-2">
                <NavLink to="/" className="nav-link text-nowrap">
                  {t("header.0")}
                </NavLink>
              </li>
              <li className="pe-2">
                <NavLink to="/shop/all" className="nav-link text-nowrap">
                  {t("header.1")}
                </NavLink>
              </li>
              <li className="pe-2">
                <NavLink to="/collection" className="nav-link text-nowrap">
                  {t("header.2")}
                </NavLink>
              </li>
              <li className="pe-2">
                <NavLink to="/blog" className="nav-link text-nowrap">
                  {t("header.3")}
                </NavLink>
              </li>
              {/* <li>
          ...
          <div className="col-lg-6 col-md-5 col-sm-5 col-6 ">
            <div className=" d-xl-flex float-end align-items-center">
              ...
              {/*Login Page  */}
              <div className="d-none d-xl-block d-flex justify-content-between ">
              ...
              {/*  WishList Page  */}
              <NavLink to="/wishlist" className="nav-link fs-4   d-none d-xl-block  " style={{width:'45px'}}>
             ...
             {/*  Add to Card Page  */}
             <NavLink to="/cart" className="nav-link fs-4  d-none d-xl-block mx-1 "  style={{width:'45px'}}>
              ...
              {/*  Dark-Light Mode  */}
                <button className="btn d-none d-xl-block " onClick={()=>toggleTheme()}>{darkMode ? <BsMoonFill className="text-secondary"/> : <BsFillSunFill className="text-warning"/>}</button>
              {/*  --------------  */}
